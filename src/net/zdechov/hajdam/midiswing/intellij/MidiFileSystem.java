...
/**
 * File system for MIDI files.
 */
@ParametersAreNullableByDefault
public class MidiFileSystem extends VirtualFileSystem implements DumbAware {

    private static final String PROTOCOL = "midiswing";
    private static final String ERROR_INVALID_OPERATION = "Invalid operation";
    private static final MidiFileSystem INSTANCE = new MidiFileSystem();
    private List<VirtualFileListener> fileListeners = new ArrayList<>();

    @NotNull
    public static MidiFileSystem getInstance() {
        return INSTANCE;
    }
